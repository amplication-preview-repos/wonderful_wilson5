...
class LibraryUpdateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => LibrarianUpdateManyWithoutLibrariesInput,
  })
  @ValidateNested()
  @Type(() => LibrarianUpdateManyWithoutLibrariesInput)
  @IsOptional()
  @Field(() => LibrarianUpdateManyWithoutLibrariesInput, {
    nullable: true,
  })
  ...
  @ApiProperty({
    required: false,
    type: () => BookUpdateManyWithoutLibrariesInput,
  })
  @ValidateNested()
  @Type(() => BookUpdateManyWithoutLibrariesInput)
  @IsOptional()
  @Field(() => BookUpdateManyWithoutLibrariesInput, {
    nullable: true,
  })
