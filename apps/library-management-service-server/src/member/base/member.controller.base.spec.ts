  ...
  test("POST /members", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        membershipDate: CREATE_RESULT.membershipDate.toISOString(),
      });
  });
      ...
      .expect([
        {
          ...
          membershipDate: FIND_MANY_RESULT[0].membershipDate.toISOString(),
        },
      ]);
  });
  ...
  test("GET /members/:id existing", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        membershipDate: FIND_ONE_RESULT.membershipDate.toISOString(),
      });
  });
